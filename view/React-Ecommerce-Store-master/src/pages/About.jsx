...
const MyAbout = () => {
    // const { counterState, Plus, Minus, state2, setText } = useContext(PersonContext);
    ...
    return (
        ...
        //     <button onClick={e => Plus(Number(state2))}>PLUS</button>
        ...
        //     </Typography> */}
            <Autocomplete
                ...
                renderOption={(props, data) => {
                    console.log(props)
                    return (<strong>{`${data.label} - ${data.year}`}<br/><br/></strong> )
                }}
            />
        </div>
    )
